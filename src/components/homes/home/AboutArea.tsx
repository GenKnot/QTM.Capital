...
const AboutArea = () => {
  return (
    <>
      <div id="about-area" className="about-us-wrapper">
            ...
            <div className="col-12 col-md-6">
              <div className="about-us-text-content ps-md-4">
                <div className="section-heading">
                  <h2 className="mb-0">我们的使命与愿景</h2>
                </div>
                <p className="mb-0">无论在经济发展的哪个周期，中小企业永远都是推动社会经济发展的核心动力。我们相信，中小型企业就如同量子一样，只要引领得当，会迸发出最惊人的价值。</p>
