...
const ProjectsArea = () => {
  return (
    <>
      <div id="quantum-capital" className="projects-wrapper bg-secondary">
          ...
          <div className="row g-4 align-items-end justify-content-between">
            ...
            <div className="col-12 col-md-4 col-lg-4">
              <div className="text-md-end">
                <a href="/industrial-mergers" className="btn btn-primary"><span>了解产业并购</span><span>了解产业并购</span></a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="row g-4 g-xl-5">
            ...
            <div className="col-md-6">
              <div className="portfolio-card">
                ...
                <div className="portfolio-overlay-content d-flex align-items-center justify-content-between">
                  <div className="me-4">
                    <h3 className="mb-0">商业计划及商业孵化</h3>
            ...
            <div className="col-md-6">
              <div className="portfolio-card">
                ...
                <div className="portfolio-overlay-content d-flex align-items-center justify-content-between">
                  <div className="me-4">
                    <h3 className="mb-0">私募股权及融资咨询</h3>
