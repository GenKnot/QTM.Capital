            ...
            <div className="col-md-5 col-xl-6">
              <div className="section-heading">
                ...
                <ul className="mb-4">
                  ...
                  <li>企业有成熟的商业模式，并且经过量子资本的评估或升级后可以复制。</li>
                  <li>企业有稳定的销售团队。</li>
              ...
              <div className="work-process">
                ...
                <div className="process-card">
                  ...
                  <div className="process-text">
                    <h4>模式升级</h4>
                    <p className="mb-0">根据"攒局者"企业的情况，量子资本会从企业文化、商业模式、战略规划、营销模型四个方面进行全面升级。形成一套符合当下资本追捧热点、拥有高估值概念的产业模型，并根据这套产业模型制定可以复制的并购方案。</p>
                  </div>
                </div>
                ...
                <div className="process-card">
                  ...
                  <div className="process-text">
                    <h4>换股并购</h4>
                    <p className="mb-0">在全球范围内选取符合产业模型要求的中小型企业进行并购。并购过程中一般采用"现金+换股"的模式，现金部分量子资本的美元基金会进行直投或者由量子资本担任融资顾问向外部投资者进行股权融资。如果是用换股的模式进行并购，则双方可约定在3-5年内未完成上市计划，则互相退还股份，撤销所有协议。</p>
                  </div>
                </div>
                ...
                <div className="process-card">
                  ...
                  <div className="process-text">
                    <h4>上市或借壳</h4>
                    <p className="mb-0">在整个并购后的产业集团达到一定的利润额，且该利润额有相对应的纳税数据后。根据并购框架，选择进行独立上市或者被已经合作的上市公司并购。量子资本将配合券商、律所等第三方机构共同完成这个进程。</p>
                  </div>
                </div>
